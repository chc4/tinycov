...
namespace tinykvm {
	...
	static constexpr uint64_t INTR2_ASM_ADDR = 0x3000;
	static constexpr uint64_t IST_ADDR = 0x4000;
	static constexpr uint64_t IST2_ADDR = 0x5000;
	static constexpr uint64_t IST_END_ADDR = 0x6000;
	static constexpr uint64_t USER_ASM_ADDR = 0x6000;
	static constexpr uint64_t VSYS_ADDR = 0x7000;
	static constexpr uint64_t TSS_SMP_ADDR = 0x8000;
	static constexpr uint64_t TSS_SMP2_ADDR = 0x9000;
	...
	static constexpr uint64_t PT_ADDR  = 0xa000;
